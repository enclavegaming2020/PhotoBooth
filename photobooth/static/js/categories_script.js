...
var box_content_1 = document.querySelector("#box-content-1");
var box_content_2 = document.querySelector("#box-content-2");
var box_content_3 = document.querySelector("#box-content-3");
var box_content_4 = document.querySelector("#box-content-4");
...
var add_img = function(){
    for(k=0 ; k < 5 ; k++){
        ...
        img_1.src = wallimage[k]
        a.appendChild(img_1)
        box_content_1.appendChild(a)
    }
    ...
    for(t=5 ; t<10 ; t++){
        ...
        a.href = "#"
        var img_1 = document.createElement("img")
        img_1.src = wallimage[t]
        a.appendChild(img_1)
        box_content_2.appendChild(a)
    }
    ...
    for(p=10 ; p<15 ; p++){
        ...
        a.href = "#"
        var img_1 = document.createElement("img")
        img_1.src = wallimage[p]
        a.appendChild(img_1)
        box_content_3.appendChild(a)
    }
    ...
    for(q=15 ; q<20 ; q++){
        ...
        a.href = "#"
        var img_1 = document.createElement("img")
        img_1.src = wallimage[q]
        a.appendChild(img_1)
        box_content_4.appendChild(a)
    }  
}
...
var mobile_img = ["https://img.playbook.com/KnpDPt1YlGzeA9aExu8JT_wgrcNj8gPQLwttib8pEZw/Z3M6Ly9wbGF5Ym9v/ay1hc3NldHMtcHVi/bGljL2M5ZGIzNzZm/LTIxYmItNDc3Ni04/MWU1LTNlYWRjYjQ3/ZDQ4Nw",
...
var box_content_1_2 = document.querySelector("#box-content-1_2");
var box_content_2_2 = document.querySelector("#box-content-2_2");
var box_content_3_2 = document.querySelector("#box-content-3_2");

var add_img_2 = function(){
    for(k=0 ; k < 5 ; k++){
        var a = document.createElement("a")
        a.href = "#"
        var img_1 = document.createElement("img")
        img_1.src = mobile_img[k]
        a.appendChild(img_1)
        box_content_1_2.appendChild(a)
    }
    ...
    for(t=5 ; t<10 ; t++){
        ...
        a.href = "#"
        var img_1 = document.createElement("img")
        img_1.src = mobile_img[t]
        a.appendChild(img_1)
        box_content_2_2.appendChild(a)
    }
    ...
    for(p=10 ; p<15 ; p++){
        ...
        a.href = "#"
        var img_1 = document.createElement("img")
        img_1.src = mobile_img[p]
        a.appendChild(img_1)
        box_content_3_2.appendChild(a)
    }
}
